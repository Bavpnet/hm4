...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text("PROJECT");
    			add_location(button0, file$3, 4, 0, 119);
    			add_location(button1, file$3, 7, 0, 204);
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	const click_handler = () => dispatch('click', 'main');
    	const click_handler_1 = () => dispatch('click', 'project');
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div3 = element("div");
    			div0 = element("div");
    			div0.textContent = "THIS is API about random dogs 🐶";
    			t1 = space();
    			div1 = element("div");
    			button = element("button");
    			button.textContent = "тык";
    			t3 = space();
    			div2 = element("div");
    			img = element("img");
    			attr_dev(div0, "class", "flexbox1 svelte-rysrxi");
    			add_location(div0, file$2, 15, 8, 400);
    			attr_dev(button, "id", "generate1");
    			attr_dev(button, "class", "svelte-rysrxi");
    			add_location(button, file$2, 19, 12, 526);
    			attr_dev(div1, "class", "flexbox2");
    			add_location(div1, file$2, 18, 8, 491);
    			attr_dev(img, "id", "image");
    			if (!src_url_equal(img.src, img_src_value = "")) attr_dev(img, "src", img_src_value);
    			add_location(img, file$2, 26, 12, 677);
    			attr_dev(div2, "class", "image-container");
    			add_location(div2, file$2, 24, 8, 634);
    			attr_dev(div3, "class", "flexbox-container svelte-rysrxi");
    			add_location(div3, file$2, 14, 4, 360);
    			add_location(main, file$2, 13, 0, 349);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			img = element("img");
    			if (!src_url_equal(img.src, img_src_value = "./img/WELCOME.svg")) attr_dev(img, "src", img_src_value);
    			add_location(img, file$1, 15, 4, 229);
    			attr_dev(div, "class", "welcome svelte-uccg48");
    			add_location(div, file$1, 14, 0, 203);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	button.$on("click", /*returnType*/ ctx[1]);
    	const if_block_creators = [create_if_block, create_else_block];
    	const if_blocks = [];

    	function select_block_type(ctx, dirty) {
    		if (/*typebtn*/ ctx[0] === 'main') return 0;
    		return 1;
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			if_block.c();
    			add_location(li, file, 17, 16, 358);
    			attr_dev(ul, "class", "header-links");
    			add_location(ul, file, 15, 12, 315);
    			attr_dev(nav, "class", "header-container");
    			add_location(nav, file, 14, 8, 272);
    			add_location(header, file, 12, 4, 254);
    			add_location(main, file, 11, 0, 243);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ('typebtn' in $$props) $$invalidate(0, typebtn = $$props.typebtn);
    	};
